...
Authored 2026-04-30 against the `award-compliance-extraction` (Workflow_ID: `WF-AWARD-COMPLIANCE-EXTRACTION`) process-mapping workflow in `ui-insight/ProcessMapping`.
