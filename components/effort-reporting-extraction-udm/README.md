...
Authored 2026-04-30 against the `effort-reporting-extraction` (Workflow_ID: `WF-EFFORT-REPORTING-EXTRACTION`) process-mapping workflow in `ui-insight/ProcessMapping`.
