...
Authored 2026-04-30 against the `foa-checklist-extraction` (Workflow_ID: `WF-FOA-CHECKLIST-EXTRACTION`) process-mapping workflow in `ui-insight/ProcessMapping`.
