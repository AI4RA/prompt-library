...
The canonical runtime for this component is the [`rfa-checklist-extraction` workflow](../../workflows/rfa-checklist-extraction/) shipped at the top level of this repo. The single source of truth is [`workflows/rfa-checklist-extraction/manifest.yaml`](../../workflows/rfa-checklist-extraction/manifest.yaml); the companion `.vandalizer.json` envelope is generated by [`scripts/build_vandalizer_workflows.py`](../../scripts/build_vandalizer_workflows.py) and committed alongside. The runtime mirrors the source [`ui-insight/ProcessMapping/workflows/rfa-checklist-extraction/`](https://github.com/ui-insight/ProcessMapping/tree/main/workflows/rfa-checklist-extraction) workflow:
